...
<div
      ...
      style="background-image: url('{{ asset('frondend/images/hero_bg_3.jpg') }}')"
    >
      <div class="container">
        ...
        <div class="row justify-content-between mb-5">
          <div class="col-lg-7 mb-5 mb-lg-0 order-lg-2">
            <div class="img-about dots">
              <img src="{{ asset('frondend/images/hero_bg_3.jpg') }}" alt="Image" class="img-fluid" />
            </div>
          </div>
          <div class="col-lg-4">
      ...
      <div class="container">
        <div class="row justify-content-between mb-5">
          <div class="col-lg-7 mb-5 mb-lg-0">
            <div class="img-about dots">
              <img src="{{ asset('frondend/images/hero_bg_2.jpg') }}" alt="Image" class="img-fluid" />
            </div>
          </div>
          <div class="col-lg-4">
            <div class="d-flex feature-h">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="0">
            <img src="{{ asset('frondend/images/img_1.jpg') }}" alt="Image" class="img-fluid" />
          </div>
          <div class="col-md-4 mt-lg-5" data-aos="fade-up" data-aos-delay="100">
            <img src="{{ asset('frondend/images/img_3.jpg') }}" alt="Image" class="img-fluid" />
          </div>
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
            <img src="{{ asset('frondend/images/img_2.jpg') }}" alt="Image" class="img-fluid" />
          </div>
        </div>
          ...
          <div class="testimonial-slider">
            <div class="item">
              <div class="testimonial">
                <img
                  src="{{ asset('frondend/images/person_1-min.jpg') }}"
                  alt="Image"
            ...
            <div class="item">
              <div class="testimonial">
                <img
                  src="{{ asset('frondend/images/person_2-min.jpg') }}"
                  alt="Image"
                  class="img-fluid rounded-circle w-25 mb-4"
                />
            ...
            <div class="item">
              <div class="testimonial">
                <img
                  src="{{ asset('frondend/images/person_3-min.jpg') }}"
                  alt="Image"
                  class="img-fluid rounded-circle w-25 mb-4"
                />
            ...
            <div class="item">
              <div class="testimonial">
                <img
                  src="{{ asset('frondend/images/person_4-min.jpg') }}"
                  alt="Image"
                  class="img-fluid rounded-circle w-25 mb-4"
                />
